...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ProfileAvatar; });
...
function () {
  ...
  _createClass(ProfileAvatar, [{
    ...
    key: "profileModal",
    value: function profileModal() {
      var modalType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'show';
      jQuery('#profileAvatarModal').modal(modalType);
    }
  }, {
    key: "changeMyProfile",
    value: function changeMyProfile() {
      var self = this;
    ...
    key: "modalProfilePhotoSelection",
    value: function modalProfilePhotoSelection() {
      var self = this;
      jQuery('.profile-photo').each(function () {
        $(this).click(function () {
          if (!window.myProfile.update_profile_url) throw 'No url found';
          var uploadProfileType = $(this).data('profile-type');
          var data = {
    ...
    key: "changeAvatarByUpload",
    value: function changeAvatarByUpload() {
      var self = this;
    ...
    key: "_readFile",
    value: function _readFile(input) {
      var self = this;
    ...
    value: function sendRequest(data) {
      axios.post(window.myProfile.update_profile_url, data).then(function (response) {
        // hide modal.
        self.profileModal('hide'); // and reload page
    ...
    key: "hideCurrentImage",
    value: function hideCurrentImage() {
      $(".avatar-wrapper .avatar-preview").hide();
    }
  }, {
    key: "changeMyPhotoBtn",
    value: function changeMyPhotoBtn() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'show';
      var btn = $('#changeMyPhoto');
    ...
    key: "initializeCroppiePlugin",
    value: function initializeCroppiePlugin(image) {
      var vHeight = 202;
      var avatar = $('#avatar');
      ...
      if (vWidth > 250) {
        vWidth = (_readOnlyError("vWidth"), 250);
      }

      avatar.croppie('destroy');
      var croppie = avatar.croppie({
        viewport: {
          width: vWidth,
          height: vWidth,
          type: 'circle'
    ...
    key: "cancelUploadPhoto",
    value: function cancelUploadPhoto() {
      var self = this;
...
module.exports = __webpack_require__(/*! /Users/anthonypillos/Desktop/Projects/v2-googelplayappstore/resources/js/profile.js */"./resources/js/profile.js");
