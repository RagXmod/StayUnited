...
<html>
<head>
	<title>{{ dcmConfig('site_title')  }}</title>
...
<body marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" style="background-color:#F6F6F6;  font-family:Arial,serif; margin:0; padding:0; min-width: 100%; -webkit-text-size-adjust:none; -ms-text-size-adjust:none;">
    ...
    <!-- START PRE HEADER -->
    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" st-sortable="preheader">
        <tr>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table width="640" cellpadding="0" cellspacing="0" border="0" class="container">
                                ...
                                <tr>
                                    <td width="300" class="mobile" align="left" style="font-family: Arial, sans-serif; font-size:12px; line-height:18px;" st-content="preheader">
                                        Account Activation - {{ dcmConfig('site_title')  }}
                                    </td>
                                    <td width="300" class="mobile" align="right" style="font-family: Arial, sans-serif; font-size:12px; line-height:18px;" st-content="preheader">
                                        <a href="{{ url('/') }}" target="_blank" alias="" style="font-size:12px; line-height:18px; color:#222222; text-decoration:underline;">Visit Our Site</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="10" style="font-size:10px; line-height:10px;"> </td><!-- Spacer -->
                        ...
                        <tr>
                            <td align="center" bgcolor="#ffffff">
                                ...
                                <table width="640" cellpadding="0" cellspacing="0" align="center" border="0" class="container">
                                    ...
                                    <tr>
                                        <td align="left" style="font-family:Verdana, Arial, sans serif; font-size: 14px; color: #4d4d4d; line-height:18px; padding:0 20px;" st-content="title+text">

                                            <strong>Hello {{ $data['first_name'] }}, </strong>
                                            <br/><br/>

                                            Please visit this link to reset your password.
                                            <a href="{{ $data['reminder_link'] }}">Click here to reset password</a>
                                            <br/>
                                            <strong>Reset Password Code: </strong> {{ $data['reminder_code'] }}
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table width="640" cellpadding="0" cellspacing="0" border="0" class="container">
                                ...
                                <tr>
                                    <td width="400" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; color:#FFFFFF; padding-left:20px;" st-content="footer">
                                        &copy; {{ now()->format('Y') }} All Rights Reserved - {{ dcmConfig('site_title') }}
                                    </td>
                                    <td height="10" style="font-size:10px; line-height:10px;" class="mobileOn"></td>
                                    <td width="300" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; color:#FFFFFF; padding-right:20px;" align="right" st-content="footer">
