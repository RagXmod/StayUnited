    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
           <h3 class="block-title">
               <i class="fas fa-book-open mr-2"></i> Static Pages
            </h3>
            <a href="{{ route('admin.page.create') }}" class="btn btn-success btn-xs">
                <i class="fa fa-file-alt mr-2"></i> Add New Page
            </a>
        </div>
...
<div id="deleteModal" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <p class="description">Are you sure you want to delete this page [<strong><span id="itemId"></span></strong>]?</p>
