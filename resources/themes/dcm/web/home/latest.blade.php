   ...
   <div class="col-md-12" itemscope itemtype="http://schema.org/MobileApplication">
      <div class="block block-themed">
        <div class="block-header bg-light">
            <h3 class="block-title"><a href="{{ url('/') }}">{{ __('dcm.home')}}</a> {{ __('dcm.breadcrumb_divider') }} {{ __('dcm.home_latest_featured_title',['attr' => $featured_app->title]) }} </h3>
        </div>

        <div class="block-content px-0 pt-0" >
            <div class="content 3" itemprop="description" id="app_description">
                {!! nl2br( trim(@$featured_app->description)) !!}
            </div>
        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-10 mb-5 mt-1" style="padding: 0 25px;">
                        ...
                        <div>
                            ...
                            <span class="details-delimiter"> | </span>
                                <a href="{{ $app->app_detail_url }}" title="{{ $app->title }} class="details-to-bottom" data-type="reviews">{{ __('dcm.total_reviews', ['attr' => 0]) }}</a>
                            <span class="details-delimiter"> | </span>
                                <a href="{{ $app->app_detail_url }}"  class="details-to-bottom" data-type="posts">{{ __('dcm.total_comments', ['attr' => $app->comments->count()]) }}</a>
                        </div>
